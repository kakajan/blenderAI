...
const copy = {
  en: {
    ...
    "features.f4.title": "MCP for your AI tools",
    "features.f4.body":
      "Drive the same open Blender scene from Cursor, Claude Desktop, Claude Code, Windsurf, VS Code, and more.",
    ...
    "docs.mcp": "MCP setup →",
    "mcp.eyebrow": "MCP",
    "mcp.title": "One live scene — many AI tools",
    "mcp.lead": "The installer wires BlenderAI into your agents. Restart each app after setup.",
  ...
  fa: {
    ...
    "features.f4.title": "MCP برای ابزارهای AI شما",
    "features.f4.body":
      "همان صحنه باز بلندر را از Cursor، Claude Desktop، Claude Code، Windsurf، VS Code و بیشتر برانید.",
    "how.eyebrow": "سه قدم",
    ...
    "mcp.eyebrow": "MCP",
    "mcp.title": "یک صحنه زنده — چند ابزار AI",
    "mcp.lead": "اینستالر BlenderAI را به ایجنت‌های شما وصل می‌کند. بعد از نصب هر اپ را ری‌استارت کنید.",
